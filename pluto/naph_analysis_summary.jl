...
begin
	...
	const SUMMARY_DIR = "/Users/jjgomezcadenas/Projects/BoldLab/naph_analysis_summary"
...
md"""
# NAPH Analysis Summary Dashboard

This notebook provides interactive visualization and analysis of the NAPH batch analysis results.

## Overview
- **Fake Samples**: Control measurements with no NAPH signal
- **Signal Samples**: Measurements with NAPH molecules  
- **Filters**: Spectral filters Filter3 through Filter8
- **Metrics**: Total intensity, peak counts, and PELT molecule counts
...
begin
	...
	master_df = CSV.read(joinpath(SUMMARY_DIR, "master_summary.csv"), DataFrame)
	
	# Separate fake and signal data
	fake_data = filter(row -> row.Type == "Fake", master_df)
	signal_data = filter(row -> row.Type == "Signal", master_df)
	
	# Define sample and filter lists
	filters = ["Filter3", "Filter4", "Filter5", "Filter6", "Filter7", "Filter8"]
	fake_samples = [
		"FakeA1_0.5monolayer",
		"FakeA1_pre", 
...
manifest_format = "2.0"
project_hash = "dbb3f54c0389adb82e5e563423df9d6405a0880a"
