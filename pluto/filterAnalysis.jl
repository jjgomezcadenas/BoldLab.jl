...
begin
    BASEDIRS = Dict("test_F12" =>"/Users/jjgomezcadenas/BoldLab/BOLD/Alfonso/2025_03_Blank_measurements_campaign/test_F12_remove_laser_light"	    )
    base_directory(label) = BASEDIRS[label]
	root_dir =  base_directory("test_F12")
end

# ╔═╡ 89ac3496-c36a-4472-a21c-bf4fca5e79d6
begin
   subdirs, _, _ = scan_level(root_dir)
   @bind sdir Select(subdirs)
end

# ╔═╡ 55be7ed5-4229-4c5e-baf5-8cf142b358f1
begin
   fields, _, _ = scan_level(joinpath(root_dir, sdir) )
   @bind sfield Select(fields)
end

# ╔═╡ 2c50b5b4-a227-423a-bd4b-812fb4cd425c
begin
	path_tiff = joinpath(root_dir, sdir, sfield)
...
# ╔═╡ 56307beb-9a0b-481c-a608-46b03aa055eb
md"""
- Total intensity $(sum(totalI))
"""
